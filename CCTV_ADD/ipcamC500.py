...
# http://localhost:1883/camera/objects
...
cap = cv2.VideoCapture('rtsp://admin:AI!!3203@192.168.0.12:554')
print(cap)
...
# mosquitto -c mosquitto.conf ipcam과 파이썬을 연결하는 서버
# 실행은 python ipcamC500.py
